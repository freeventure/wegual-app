  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<c:url value="${beneficiaryProfileData.beneficiary.pictureLink}" />" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">${beneficiaryProfileData.beneficiary.name}</a>
        </div>
      </div>
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="<c:url value="${beneficiaryProfileData.beneficiary.pictureLink}" />"
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Followers</b> <a class="float-right">${beneficiaryProfileData.counts.followers}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Benefactors</b> <a class="float-right">${beneficiaryProfileData.counts.benefactors}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Pledges</b> <a class="float-right">${beneficiaryProfileData.counts.pledges}</a>
                  </li>
				</ul>
              </div>
              <!-- /.card-body -->
                  ...
                  <div class="active tab-pane" id="settings">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputName" value="${beneficiaryProfileData.beneficiary.username}" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Name</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName2" value=" ${beneficiaryProfileData.beneficiary.name}" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputEmail" value=" ${beneficiaryProfileData.beneficiary.email}" placeholder="Email">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputAboutMe" class="col-sm-2 col-form-label">Description</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputAboutMe" value=" ${beneficiaryProfileData.beneficiary.description}" placeholder="About Me"></textarea>
                        </div>
                      </div>
                      <div class="form-group row">
